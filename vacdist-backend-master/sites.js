...
router.get('/nearby', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var request, decodedToken, qs, i, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                request = JSON.parse(req.params);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4, index_js_1.admin
                        .auth()
                        .verifyIdToken(request.authtoken)];
            case 2:
                decodedToken = _a.sent();
                return [4, index_js_1.db.collection('vac_site').get()];
            case 3:
                qs = _a.sent();
                ...
                qs.docs.sort(function (a, b) { return a.distance - b.distance; });
