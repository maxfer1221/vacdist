...
function writeOptimalLocation(zip) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, findOptimalLocation(zip)];
                case 1:
                    location = _a.sent();
                    return [4 /*yield*/, index_js_1.db.collection('optimal_locations').add({
                            zip: zip,
                            lat: location.lat,
                            long: location.long,
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    radius = 5;
                    return [4 /*yield*/, zipCodesFromRadius(zip, radius)];
                case 1:
                    zips = _a.sent();
                    return [4 /*yield*/, findZipAppearances(zips)];
                case 2:
                    appearances = _a.sent();
                    return [4 /*yield*/, runPythonScript("./python/optimalLocation.py", [JSON.stringify(appearances)])];
                case 3:
                    pyout = _a.sent();
                    if (!pyout.error) {
                        return [2 /*return*/, JSON.parse(pyout.scriptOutput)];
                    }
                    return [2 /*return*/, __assign({ lat: undefined, long: undefined }, pyout)];
            }
        });
    });
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(zips.length > 0)) return [3 /*break*/, 3];
                    short_zips = zips.splice(0, 10);
                    return [4 /*yield*/, index_js_1.usersRef.where('zip', 'in', short_zips).get()];
                case 2:
                    users = _a.sent();
...
function zipCodesFromRadius(zip, radius) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, zipCodeApi_get(zip, radius)];
                case 1:
                    res = _a.sent();
                    return [4 /*yield*/, res.json()];
                case 2:
                    json = _a.sent();
                    return [2 /*return*/, json.zip_codes.map(function (el) { return el.zip_code; })];
            }
        });
    });
}
...
function runPythonScript(pathToScript, parameters) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, exec("py \"" + pathToScript + "\" " + parameters.join(' '))];
                case 1:
